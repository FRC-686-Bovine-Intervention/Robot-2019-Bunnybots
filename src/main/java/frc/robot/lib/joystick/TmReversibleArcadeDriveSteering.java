 ...
 * turn.
 */
public class TmReversibleArcadeDriveSteering extends ReversibleSteeringBase
{
    JoystickBase lStick;
    JoystickBase rStick;
    ...
    public TmReversibleArcadeDriveSteering(JoystickBase _lStick, JoystickBase _rStick, DeadbandNonLinearity _deadbandNonLinearity) 
    {
...
// System.out.printf("lThrottle: %5.3f, lTurn: %5.3f, rThrottle: %5.3f, rTurn: %5.3f, lAct:%b, rAct:%b, usingLeft:%b\n", lThrottle, lTurn, rThrottle, rTurn, leftStickActive, rightStickActive, usingLeftStick);
    ...
    private final DataLogger logger = new DataLogger()
    {
        ...
        public void log()
        {
            put("TmReversibleArcadeDriveSteering/throttle", throttleTurn.throttle);
            put("TmReversibleArcadeDriveSteering/turn", throttleTurn.turn);
            put("TmReversibleArcadeDriveSteering/left", driveCmd.getLeftMotor());
            put("TmReversibleArcadeDriveSteering/right", driveCmd.getRightMotor());
        }
    };        
}
